	...
	<div class="span2">
		...
		<div id="my_menu" class="sdmenu">
			<c:if test="${ not empty user_manage }">
				<div>
					<spanlist>人员管理</spanlist>
					<a id="" href="user-manage.do?action=add">添加用户</a> <a id=""
						href="user-audit.do">审核用户</a> <a id="" href="user-manage.do">管理用户</a>
				</div>
			</c:if>
			<c:if test="${ not empty project_manage }">
				<div>
					<spanlist>项目管理</spanlist>
					<a href="project-create.do">创建项目</a> <a href="project-manage.do">管理项目</a>
				</div>
			</c:if>
			<c:if test="${ not empty bug_manage }">
				<div>
					<spanlist>BUG管理</spanlist>
					<a href="mybug.do">我的BUG</a>
					<c:if test="${ not empty bug_manage_add }">
						<a href="bug-add.do">创建BUG</a>
					</c:if>
					<a href="tobugs.do">查询BUG</a>
				</div>
			</c:if>
			<div>
				<spanlist>其他功能</spanlist>
